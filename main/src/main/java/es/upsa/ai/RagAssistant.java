 ...
 * language of the user's message. Rewriting the prompt in English is a change of behaviour, not a
 * translation, and it has to be measured again against the golden set.
 */
@RegisterAiService
@ApplicationScoped
